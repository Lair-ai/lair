...
cat > /usr/local/bin/lair-emergency-debug.sh << 'EOF'
#!/bin/bash
...
chmod +x /usr/local/bin/lair-emergency-debug.sh
```
...
echo "- Emergency debug: /usr/local/bin/lair-emergency-debug.sh"
echo "- Full debug logs: /usr/local/bin/lair-debug-logs.sh"
